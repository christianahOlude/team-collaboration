...
// Using slightly different icon styles to better match the new image.
...
const DashboardContent = ({ activeItemName }) => {
    return (
        <div className="flex-1 p-8 sm:p-12">
            <h1 className="text-3xl font-bold text-gray-900 mb-6">
                {activeItemName}
            </h1>
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 min-h-[60vh]">
                <p className="text-lg text-gray-600">
                    You are viewing the content for the **{activeItemName}** section.
                </p>

                {activeItemName === 'Home' && (
                    <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="p-4 bg-indigo-50 rounded-lg shadow-inner">
                            <h3 className="text-sm font-medium text-indigo-700">Total Learners</h3>
                            <p className="text-2xl font-bold text-indigo-900">1,250</p>
                        </div>
                         <div className="p-4 bg-yellow-50 rounded-lg shadow-inner">
                            <h3 className="text-sm font-medium text-yellow-700">Pending Assessments</h3>
                            <p className="text-2xl font-bold text-yellow-900">45</p>
                        </div>
                         <div className="p-4 bg-green-50 rounded-lg shadow-inner">
                            <h3 className="text-sm font-medium text-green-700">Active Courses</h3>
    ...
    return (
        <div className="flex min-h-screen bg-gray-50">
            ...
            <div className="flex-1 lg:ml-64 transition-all duration-300">
                ...
                {/* Top Bar/Navbar */}
                <header className="sticky top-0 z-20 flex items-center justify-between h-16 bg-white border-b border-gray-200 shadow-sm px-6">
                    <button
                    ...
                    <div className="flex-1 flex justify-end items-center space-x-4">
                        <div className="flex items-center space-x-2">
                            ...
                            <div className="w-10 h-10 rounded-full bg-indigo-200 flex items-center justify-center text-indigo-800 font-semibold text-base">D</div>
                        </div>
                    </div>
                </header>

                {/* Dashboard Content - Renders based on the path */}
                <DashboardContent activeItemName={activeItem} />
            </div>
